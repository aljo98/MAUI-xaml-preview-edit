...
exports.PropertiesWebviewProvider = void 0;
/**
 * WebviewViewProvider that renders an inline HTML form for editing
 * MAUI element properties directly in the sidebar panel.
 */
class PropertiesWebviewProvider {
    constructor(_extensionUri) {
        this._extensionUri = _extensionUri;
        this._colorSuggestions = [];
        this._styleSuggestions = [];
        this._resourceSuggestions = [];
    }
            ...
            switch (message.type) {
                case 'propertyChanged': {
                    if (this._selectedElement && this.onPropertyChanged) {
                        ...
                        if (prop) {
                            this.onPropertyChanged(prop, message.value);
                        }
                    }
                    break;
                }
    ...
    setSuggestions(colors, styles, resources) {
...
<script>
    ...
    _renderElement(el, appearance, layout, availableKeys) {
    ...
    _toHex(color) {
        ...
        if (lower.startsWith('#') && lower.length === 9) {
...
exports.PropertiesWebviewProvider = PropertiesWebviewProvider;
PropertiesWebviewProvider.viewType = 'mauiProperties';
PropertiesWebviewProvider.PROPERTY_SUGGESTIONS = [
...
//# sourceMappingURL=propertiesWebviewProvider.js.map